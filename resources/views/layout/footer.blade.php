...
<footer>
    <div class="container">
        <div class="row">
            <div class="col-md-4 col-sm-6 mb-4">
                <div class="d-flex align-items-start gap-3 mb-3">
                    ...
                    <h5 class="m-0">About LJD Laravel</h5>
                </div>
                <p>Building modern web applications with Laravel and Bootstrap. Applying WebDev Learning.</p>
            </div>
        ...
        <div class="footer-bottom">
            <p>&copy; 2025 LJD Laravel. All rights reserved.</p>
        </div>
    </div>
</footer>